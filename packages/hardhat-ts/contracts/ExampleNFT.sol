...
contract ExampleNFT is ERC721Enumerable {
  address payable public constant recipient = payable(0x72Dc1B4d61A477782506186339eE7a897ba7d00A);
  ...
  function _baseURI() internal view virtual override returns (string memory) {
    return "https://gateway.pinata.cloud/ipfs/QmdRmZ1UPSALNVuXY2mYPb3T5exn9in1AL3tsema4rY2QF/json/";
  }
  ...
  function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
    ...
    return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, uris[tokenId - 1])) : "";
  }
